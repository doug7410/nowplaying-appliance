...
| # | Part | Qty | ~$ | Notes |
|---|---|---|---|---|
| 1 | **ESP32-S3-DevKitC-1 N16R8** (16 MB flash, 8 MB octal PSRAM), genuine Espressif | 1 | 15 | Plugs into the carrier's two 1×22 sockets. **Must be the genuine 25.4 mm-wide board with 22.86 mm (0.9") row spacing.** The common YD-ESP32-S3 clone is 1.0" between rows and will not seat. N16R8 is required: the firmware uses the 16 MB partition table and PSRAM. |
